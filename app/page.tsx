...
export default function GamesLab() {
  ...
  return <main className="min-h-screen bg-paper text-ink">
    <header className="border-b border-ink/15"><div className="mx-auto flex max-w-xl items-center justify-between px-5 py-5"><Link className="text-sm font-semibold" href="/">When?</Link><a className="border-b border-ink text-sm" href="https://ai.rhyslindmark.com/games/how-big-bio">Bio Numbers</a></div></header>
