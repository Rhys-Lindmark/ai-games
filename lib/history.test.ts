...
void test('history library begins a sourced 1,000-question curriculum', () => {
  ...
  assert.equal(historyQuestions.length, 203);
  ...
  const lateAntiqueAndMedievalAnchorBatch = [
    'council-of-chalcedon',
    'hagia-sophia-inaugurated',
    'justinianic-plague-begins',
    'buddhism-recorded-japan',
    'sasanian-empire-ends',
    'diamond-sutra-printed',
    'chola-raids-srivijaya',
    'great-schism-1054',
    'mongols-sack-baghdad',
    'mansa-musa-hajj',
  ];
  assert.ok(lateAntiqueAndMedievalAnchorBatch.every((id) => historyQuestions.some((question) => question.id === id)));
  const earlyModernGlobalBatch = [
    'luther-ninety-five-theses',
    'tenochtitlan-falls',
    'first-battle-panipat-mughal',
    'atahualpa-captured-cajamarca',
    'copernicus-de-revolutionibus',
    'potosi-silver-exploitation',
  ...
  const preClassicalCorrectionBatch = [
    'upper-lower-egypt-unified',
    'minoan-palace-centers',
    'egypt-new-kingdom-begins',
    'nok-culture-origins',
    'late-bronze-age-disruptions',
    'lapita-reaches-tonga-samoa',
    'sennacherib-western-campaign',
    'kleisthenes-athenian-reforms',
    'historical-buddha-dies',
