...
assert.equal(audit.verified_at, [...historyQuestions].sort((left, right) => right.verifiedAt.localeCompare(left.verifiedAt))[0].verifiedAt, 'audit must be at least as fresh as its newest question');
